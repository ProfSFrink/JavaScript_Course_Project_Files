...
// Assignment #17
function assign17(a, b) { // Define function 'assign17' and have to parameters 'a' and 'b' to pass in
    document.getElementById("Subtraction").innerHTML = a - b; // Calculate the a - b and assign the result to the 'Subtraction' id 
}